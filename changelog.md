...
- [Milestone](https://github.com/unity-game-framework/ugf-module-controllers/milestone/23?closed=1)  
    

### Changed

- Update project ([#96](https://github.com/unity-game-framework/ugf-module-controllers/issues/96))  
...
- [Milestone](https://github.com/unity-game-framework/ugf-module-controllers/milestone/21?closed=1)  
    

### Added

- Add ControllerAccessComponent cache ([#92](https://github.com/unity-game-framework/ugf-module-controllers/issues/92))  
    - Add `ControllerAccessComponent` cache instance of the controller.

## [4.0.0-preview.5](https://github.com/unity-game-framework/ugf-module-controllers/releases/tag/4.0.0-preview.5) - 2022-11-04  

### Release Notes

- [Milestone](https://github.com/unity-game-framework/ugf-module-controllers/milestone/20?closed=1)  
    

### Added

- Add controller access component ([#90](https://github.com/unity-game-framework/ugf-module-controllers/issues/90))  
...
- [Milestone](https://github.com/unity-game-framework/ugf-module-controllers/milestone/18?closed=1)  
    

### Removed

- Remove ControllerCollectionAssetListDrawer  ([#85](https://github.com/unity-game-framework/ugf-module-controllers/issues/85))  
    - Update dependencies: `com.ugf.editortools` to `2.9.0` version.
    - Remove`ControllerCollectionAssetListDrawer` internal class, use `AssetIdReferenceListDrawer` instead.
